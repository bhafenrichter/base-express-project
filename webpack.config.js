...
module.exports = {
  entry: "./src/client/js/index.ts", // what is the entrypoint (starting) for webpack we should compile
  output: {
  ...
  plugins: [
    new CopyPlugin([
      // copies the images into the dist folder
      {
    ...
    new CompressionPlugin({
      // compresses all of the js files via gzip
      test: /\.js(\?.*)?$/i,
      algorithm: "gzip",
    }),
  ],
